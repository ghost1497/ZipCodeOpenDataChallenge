...
@IonicPage()
@Component({
  selector: 'page-movietheater',
  templateUrl: 'movietheater.html',
})
export class MovietheaterPage {
  url: string;
  movieTheaterArrNotFixed = [];
  movieTheaterArry: any[];
    ...
    this.url ="https://visitdelawarebackendv2.herokuapp.com/restaurantsInDE/Movie+Theater";
      ...
      data.subscribe(result => {
        this.movieTheaterArry = result['businesses'];
      });
